...
exports.hookInterface = [
    ...
    },
    {
        ...
        context: 'This hook is run after stacks are initialized in Page.ts and Elder.js has added the standard attributes to these stacks.',
    ...
    },
    {
        ...
        context: "Executed just before data and other properties are passed to the route's Svelte template and Svelte layout.",
        use: '<p>Useful for adjusting the data object, adding properties to stacks. Could also be used to write the output of the data.js file to help with client site routing if you were so inclined. This plugin is mainly here for plugins.</p>',
        location: 'Page.ts',
    },
    {
        hook: 'headStack',
    ...
    },
    {
        ...
        use: '<p>There are several hooks that have fired before this hook to build the &lt;head&gt; tag. This hook offers access to that compiled head tag for auditing or changing. This is a power user field.</p>',
        location: 'Page.ts',
    },
    {
